...
PRODUCT_COPY_FILES += \
    ...
    vendor/google/generic_x86/proprietary/vendor/bin/halutil:$(TARGET_COPY_OUT_VENDOR)/bin/halutil \
    ...
    vendor/google/generic_x86/proprietary/vendor/etc/permissions/LowPowerMonitorDeviceStub.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/LowPowerMonitorDeviceStub.xml \
    vendor/google/generic_x86/proprietary/vendor/etc/permissions/PowerAnomalyStub.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/PowerAnomalyStub.xml \
    vendor/google/generic_x86/proprietary/vendor/etc/permissions/privapp-permissions-goldfish.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/privapp-permissions-goldfish.xml \
    ...
    vendor/google/generic_x86/proprietary/vendor/lib/hw/tv_input.default.so:$(TARGET_COPY_OUT_VENDOR)/lib/hw/tv_input.default.so \
